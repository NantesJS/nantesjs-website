...
export default function Page () {
    return (
        <MainSection className="full-text">
            ...
            <p>
                La première rencontre a eu lieu en Janvier 2012. Depuis cette
                date, les rencontres se sont faites sur une base
                irrégulomadaire. Les rencontres seront programmées 1 fois par
                mois, le 3e jeudi du mois !
            </p>
            <p>
            ...
            <p>
                Parce qu&#39;une communauté ne vit que par les discussions et
                les rencontres régulières de ses membres, participez à
                l&#39;organisation et à la vie de NantesJS sur les différents
                groupes de discussion et réseaux
            </p>
        </MainSection>
    )
}
